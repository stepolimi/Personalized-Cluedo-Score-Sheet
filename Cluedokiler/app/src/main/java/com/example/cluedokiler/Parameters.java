...
public class Parameters {
    ...
    public static int ORANGE_SECONDARY_COLOR = Color.parseColor("#f9dca7");

    public static String BW = "blackWhite";
    public static int BW_MAIN_COLOR = Color.parseColor("#424242");
    public static int BW_SECONDARY_COLOR = Color.parseColor("#A8A8A8");

    public static String WB = "whiteBlack";
    public static int WB_MAIN_COLOR = Color.parseColor("#949494");
    public static int WB_SECONDARY_COLOR = Color.parseColor("#A8A8A8");
